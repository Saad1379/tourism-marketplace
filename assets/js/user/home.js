$(document).ready(function() {
    ...
    let register_ref = $("#register_ref").val();
    if(register_ref){
        $("#signUpModel #close_modal_btn").addClass("d-none");
        $("#signUpModel #sign_in_btn_show").addClass("d-none");
        $("#signUpModel").attr({
...
$(document).on("click", ".city-link", function () {
    ...
    if (city) {
        window.location.href = `/activity?city=${encodeURIComponent(city)}`;
    }
});
