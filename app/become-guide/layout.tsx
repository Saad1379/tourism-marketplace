...
export const metadata: Metadata = {
  ...
  description:
    "Start as a TipWalk guide on the Free plan and keep it forever, then upgrade to Pro when you need more tour capacity and growth tools.",
  keywords: [
    "become a tour guide",
    "tour guide job",
    "earn money guiding",
  ...
  openGraph: {
    ...
    description:
      "Start with Free forever and scale with Pro when demand grows. Share your city, run tours, and manage bookings on TipWalk.",
