-- Migration: Update Ranked Tours RPC for Decaying Boosts
-- Description: Updates the get_ranked_tours function to apply a time-decay factor to the boost_mult, ensuring boost strength decreases as expiration approaches (Guru Walk logic).
